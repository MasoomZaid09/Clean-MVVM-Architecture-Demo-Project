 ...
 */
public abstract class Hilt_IntelliFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_IntelliFragment() {
    super();
  }

  Hilt_IntelliFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((IntelliFragment_GeneratedInjector) this.generatedComponent()).injectIntelliFragment(UnsafeCasts.<IntelliFragment>unsafeCast(this));
    }
  }
