 ...
 */
public abstract class Hilt_FlowChartFragment extends GraphFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FlowChartFragment_GeneratedInjector) this.generatedComponent()).injectFlowChartFragment(UnsafeCasts.<FlowChartFragment>unsafeCast(this));
    }
  }
