 ...
 */
public abstract class Hilt_ControlFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ControlFragment() {
    super();
  }

  Hilt_ControlFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ControlFragment_GeneratedInjector) this.generatedComponent()).injectControlFragment(UnsafeCasts.<ControlFragment>unsafeCast(this));
    }
  }
