 ...
 */
public abstract class Hilt_ErrorLogsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ErrorLogsFragment() {
    super();
  }

  Hilt_ErrorLogsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ErrorLogsFragment_GeneratedInjector) this.generatedComponent()).injectErrorLogsFragment(UnsafeCasts.<ErrorLogsFragment>unsafeCast(this));
    }
  }
