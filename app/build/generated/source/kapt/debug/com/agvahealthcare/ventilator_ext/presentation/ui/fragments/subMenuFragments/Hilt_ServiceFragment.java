 ...
 */
public abstract class Hilt_ServiceFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ServiceFragment() {
    super();
  }

  Hilt_ServiceFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ServiceFragment_GeneratedInjector) this.generatedComponent()).injectServiceFragment(UnsafeCasts.<ServiceFragment>unsafeCast(this));
    }
  }
