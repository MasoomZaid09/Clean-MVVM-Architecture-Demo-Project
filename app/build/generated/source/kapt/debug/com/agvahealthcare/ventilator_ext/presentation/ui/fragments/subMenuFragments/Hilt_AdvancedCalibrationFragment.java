 ...
 */
public abstract class Hilt_AdvancedCalibrationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AdvancedCalibrationFragment() {
    super();
  }

  Hilt_AdvancedCalibrationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdvancedCalibrationFragment_GeneratedInjector) this.generatedComponent()).injectAdvancedCalibrationFragment(UnsafeCasts.<AdvancedCalibrationFragment>unsafeCast(this));
    }
  }
