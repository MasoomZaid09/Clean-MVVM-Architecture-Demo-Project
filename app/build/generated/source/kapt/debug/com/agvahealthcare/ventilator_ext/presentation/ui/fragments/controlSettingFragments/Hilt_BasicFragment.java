 ...
 */
public abstract class Hilt_BasicFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BasicFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BasicFragment_GeneratedInjector) this.generatedComponent()).injectBasicFragment(UnsafeCasts.<BasicFragment>unsafeCast(this));
    }
  }
