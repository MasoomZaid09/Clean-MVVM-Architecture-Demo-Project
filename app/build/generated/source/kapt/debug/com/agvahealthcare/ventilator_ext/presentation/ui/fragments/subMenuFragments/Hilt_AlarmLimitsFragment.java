 ...
 */
public abstract class Hilt_AlarmLimitsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AlarmLimitsFragment() {
    super();
  }

  Hilt_AlarmLimitsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AlarmLimitsFragment_GeneratedInjector) this.generatedComponent()).injectAlarmLimitsFragment(UnsafeCasts.<AlarmLimitsFragment>unsafeCast(this));
    }
  }
