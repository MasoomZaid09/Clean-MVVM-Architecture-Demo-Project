 ...
 */
public abstract class Hilt_PressureChartFragment extends GraphFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PressureChartFragment_GeneratedInjector) this.generatedComponent()).injectPressureChartFragment(UnsafeCasts.<PressureChartFragment>unsafeCast(this));
    }
  }
