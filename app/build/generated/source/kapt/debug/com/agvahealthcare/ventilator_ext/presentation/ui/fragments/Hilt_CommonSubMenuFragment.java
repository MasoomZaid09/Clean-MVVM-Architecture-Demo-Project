 ...
 */
public abstract class Hilt_CommonSubMenuFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CommonSubMenuFragment() {
    super();
  }

  Hilt_CommonSubMenuFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CommonSubMenuFragment_GeneratedInjector) this.generatedComponent()).injectCommonSubMenuFragment(UnsafeCasts.<CommonSubMenuFragment>unsafeCast(this));
    }
  }
