 ...
 */
public abstract class Hilt_ModeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ModeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ModeFragment_GeneratedInjector) this.generatedComponent()).injectModeFragment(UnsafeCasts.<ModeFragment>unsafeCast(this));
    }
  }
