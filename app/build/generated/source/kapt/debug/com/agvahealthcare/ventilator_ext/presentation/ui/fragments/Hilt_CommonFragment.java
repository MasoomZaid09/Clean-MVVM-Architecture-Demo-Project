 ...
 */
public abstract class Hilt_CommonFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CommonFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CommonFragment_GeneratedInjector) this.generatedComponent()).injectCommonFragment(UnsafeCasts.<CommonFragment>unsafeCast(this));
    }
  }
