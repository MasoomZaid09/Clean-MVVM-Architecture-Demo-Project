 ...
 */
public abstract class Hilt_MenuFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MenuFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MenuFragment_GeneratedInjector) this.generatedComponent()).injectMenuFragment(UnsafeCasts.<MenuFragment>unsafeCast(this));
    }
  }
