 ...
 */
public abstract class Hilt_RecentPatientsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RecentPatientsFragment() {
    super();
  }

  Hilt_RecentPatientsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecentPatientsFragment_GeneratedInjector) this.generatedComponent()).injectRecentPatientsFragment(UnsafeCasts.<RecentPatientsFragment>unsafeCast(this));
    }
  }
