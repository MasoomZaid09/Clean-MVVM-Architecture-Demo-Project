 ...
 */
public abstract class Hilt_AdvancedFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AdvancedFragment() {
    super();
  }

  Hilt_AdvancedFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdvancedFragment_GeneratedInjector) this.generatedComponent()).injectAdvancedFragment(UnsafeCasts.<AdvancedFragment>unsafeCast(this));
    }
  }
