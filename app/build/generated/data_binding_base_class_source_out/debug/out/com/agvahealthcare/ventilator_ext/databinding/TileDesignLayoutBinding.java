...
public final class TileDesignLayoutBinding implements ViewBinding {
  @NonNull
  ...
  private TileDesignLayoutBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static TileDesignLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static TileDesignLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.tile_design_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static TileDesignLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new TileDesignLayoutBinding((ConstraintLayout) rootView, ccDownButtonLayout,
