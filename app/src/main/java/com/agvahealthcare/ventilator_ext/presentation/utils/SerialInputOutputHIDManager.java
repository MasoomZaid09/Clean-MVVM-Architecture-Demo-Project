...
public class SerialInputOutputHIDManager implements Runnable {
    ...
    private static final String TAG = SerialInputOutputHIDManager.class.getSimpleName();
    ...
    public SerialInputOutputHIDManager(UsbSerialPort serialPort, Listener listener) {
        mSerialPort = serialPort;
        mListener = listener;
        mReadBuffer = ByteBuffer.allocate(serialPort.getReadEndpoint().getMaxPacketSize());
    }
