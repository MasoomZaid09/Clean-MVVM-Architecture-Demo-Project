...
class ControlAdapter(private var context: Context, private var items : ArrayList<String>, private var click : OnMenuChangeListener) : RecyclerView.Adapter<ControlAdapter.MenuViewHolder>() {

    var selectedIndex = 0

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MenuViewHolder {

        val view= LayoutInflater.from(parent.context).inflate(R.layout.control_options_item_layout, parent, false)
